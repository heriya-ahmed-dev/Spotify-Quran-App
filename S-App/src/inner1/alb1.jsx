...
const Alb1 = () => {
   ...
   const fifthItem = QuranItem[4];
      ...
      useEffect(()=>{
         document.body.style.background = secondItem.bg_color;
        },[secondItem]);
        ...
        <div className='d-flex gap-5'>
           <div>
             <div className='d-flex w-75 gap-1 '>
               <div  key={secondItem.id}  className='LB h-50 rounded-3  btn btn-outline-secondary gap-2 text-center' >
                 <img src={secondItem.image} className='w50'/>
                 <p className='w50 text-white '>{secondItem.description}</p>
              </div>
          </div>
