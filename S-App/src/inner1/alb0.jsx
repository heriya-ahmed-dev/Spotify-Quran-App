...
import QuranItem from '../assets/assets1.js';
import '../App.css';
...
const Alb0 = () => {
  ...
  useEffect(() => {
    document.body.style.background = firstItem.bg_color;
  }, [firstItem]);
      ...
      <div className='mt-4 ms-5'>
        <div className='d-flex w-75 gap-1'>
          <div className='LB h-50 rounded-3 btn btn-outline-secondary text-center'>
            <img src={firstItem.image} className='w50' alt="" />
            <p className='w50 text-white'>{firstItem.description}</p>
          </div>
        </div>
      </div>
